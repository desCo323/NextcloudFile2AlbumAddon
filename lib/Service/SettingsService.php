...
class SettingsService {
	...
	public function getAdminSettings(): array {
		return [
			...
			'requireBulkDeleteConfirmation' => $this->appConfig->getAppValueBool('requireBulkDeleteConfirmation', self::ADMIN_DEFAULTS['requireBulkDeleteConfirmation']),
	...
	public function saveAdminSettings(array $input): array {
		$settings = [
			...
			'requireBulkDeleteConfirmation' => $this->boolValue($input['requireBulkDeleteConfirmation'] ?? self::ADMIN_DEFAULTS['requireBulkDeleteConfirmation']),
